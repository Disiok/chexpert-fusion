...
__all__ = [
    ...
    "CrossSectionalAttentionFusionV2",
    "VolumetricFusion",
]
...
class CrossSectionalAttentionFusionV2(nn.Module):
    def __init__(self, num_input_features):
        super(CrossSectionalAttentionFusionV2, self).__init__()
