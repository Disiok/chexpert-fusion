...
from models import registry, fusions
...
class VolumetricFusionDenseNet(nn.Module):
    def __init__(self, num_classes=10, num_init_features=64, normalization=None, activation=None):
        ...
        self.front_stream = DenseStream(num_classes=num_classes, num_init_features=num_init_features)
        self.lateral_stream = DenseStream(num_classes=num_classes, block_config=())
