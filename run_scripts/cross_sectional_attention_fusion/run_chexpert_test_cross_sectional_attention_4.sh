...
python func_run.py train_cross_sectional_attention_fusion \
    ...
    --outdir /home/kelvin.wong/experiments/chexpert_test/cross_sectional_attention_fusion_4/ \
    --checkpoint /home/kelvin.wong/experiments/chexpert_train/cross_sectional_attention_fusion_4/models/model_best.pth.tar
