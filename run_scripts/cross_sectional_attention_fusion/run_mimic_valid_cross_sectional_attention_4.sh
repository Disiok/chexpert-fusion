...
python func_run.py train_cross_sectional_attention_fusion \
    ...
    --outdir /home/suo/experiments/mimic_valid/cross_sectional_attention_fusion_4/ \
    --checkpoint /home/suo/experiments/chexpert_train/cross_sectional_attention_fusion_4/models/model_best.pth.tar
