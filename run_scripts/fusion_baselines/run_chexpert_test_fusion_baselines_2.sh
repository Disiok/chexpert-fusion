...
python func_run.py train_fusion_baselines \
    ...
    --outdir /home/suo/experiments/chexpert_test/fusion_baselines_2 \
    --checkpoint /home/suo/experiments/chexpert_train/fusion_baselines_2/models/model_best.pth.tar
