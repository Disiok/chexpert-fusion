...
python func_run.py train_cross_sectional_attention_fusion \
    ...
    --outdir /home/suo/experiments/chexpert_cross_sectional_attention_fusion_test \
    --checkpoint /home/suo/experiments/chexpert_cross_sectional_attention_fusion_unobserved_negative_0/models/model_best.pth.tar
